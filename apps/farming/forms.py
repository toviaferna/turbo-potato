...
class MaquinariaAgricolaForm(ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.helper = FormHelper()
        self.helper.layout = Layout(
            Row(Column("descripcion"), Column("tipo_maquinaria_agricola")),
            Row(
...
class LiquidacionAgricolaForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "fecha_documento": widgets.DateInput,
        }  #'precioUnitario':DecimalMaskInput}
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Fieldset(
                "Detalles",
                layouts.Formset("LiquidacionAgricolaDetalleInline"),  # , stacked=True
            ),
            Row(
                Column(
                    HTML("<label> Total: </label>"),
...
class CierreZafraForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Fieldset(
                "Detalles",
                layouts.Formset("CierreZafraDetalleInline"),  # , stacked=True
            ),
            Row(
                Column(
...
class CierreZafraDetalleForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper = FormHelper()
        self.helper.form_tag = False
        self.fields["finca"].widget.attrs.update(
            {"readonly": True, "style": "pointer-events:none;"}
        )
        self.fields["ha_cultivada"].widget.attrs.update(
            {"readonly": True, "style": "pointer-events:none;"}
        )
        self.fields["cantidad_acopio_neto"].widget.attrs.update(
            {"readonly": True, "style": "pointer-events:none;"}
        )
        self.fields["rendimiento"].widget.attrs.update(
            {"readonly": True, "style": "pointer-events:none;"}
        )
        self.fields["costo_total"].widget.attrs.update(
            {"readonly": True, "style": "pointer-events:none;"}
        )
        self.fields["costo_ha"].widget.attrs.update(
            {"readonly": True, "style": "pointer-events:none;"}
        )
