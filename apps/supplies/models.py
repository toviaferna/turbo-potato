...
class OrdenCompra(models.Model):
    pedido_compra = models.ForeignKey(
        PedidoCompra, on_delete=models.DO_NOTHING, verbose_name="Pedido Compra"
    )
    proveedor = models.ForeignKey(
        Persona, on_delete=models.DO_NOTHING, verbose_name="Proveedor"
    )
    ...
    def total(self):
        return sum(
            round(x.precio * x.cantidad) for x in self.ordencompradetalle_set.all()
        )
...
class Compra(models.Model):
    ...
    cuenta = models.ForeignKey(
        Cuenta, on_delete=models.DO_NOTHING, verbose_name="Cuenta"
    )
    deposito = models.ForeignKey(
        Deposito, on_delete=models.DO_NOTHING, verbose_name="Deposito"
    )
    fecha_documento = models.DateField(verbose_name="Fecha Documento")
...
class CuotaCompra(models.Model):
    ...
    saldo = models.DecimalField(
        max_digits=15, decimal_places=2, verbose_name="Saldo", default=0
    )
...
class NotaCreditoRecibida(models.Model):
    ...
    compra = models.ForeignKey(
        Compra, on_delete=models.DO_NOTHING, verbose_name="Compra"
    )
    cuenta = models.ForeignKey(
        Cuenta, on_delete=models.DO_NOTHING, verbose_name="Cuenta"
    )
    ...
    def total(self):
        return sum(
            round(x.valor * x.cantidad)
            for x in self.notacreditorecibidadetalle_set.all()
        )


class NotaCreditoRecibidaDetalle(models.Model):
    nota_credito_recibida = models.ForeignKey(
        NotaCreditoRecibida, on_delete=models.DO_NOTHING
    )
    item = models.ForeignKey(Item, on_delete=models.DO_NOTHING, verbose_name="Item")
    cantidad = models.DecimalField(
        max_digits=15, decimal_places=2, verbose_name="Cantidad"
    ...
    valor = models.DecimalField(
        max_digits=15, decimal_places=2, verbose_name="Costo/Descuento"
    )
...
class NotaDebitoRecibida(models.Model):
    ...
    def total(self):
        return sum(
            round(x.valor * x.cantidad)
            for x in self.notadebitorecibidadetalle_set.all()
        )


class NotaDebitoRecibidaDetalle(models.Model):
    nota_debito_recibida = models.ForeignKey(
        NotaDebitoRecibida, on_delete=models.DO_NOTHING
    )
    item = models.ForeignKey(Item, on_delete=models.DO_NOTHING, verbose_name="Item")
    cantidad = models.DecimalField(
        max_digits=15, decimal_places=2, verbose_name="Cantidad"
    ...
    valor = models.DecimalField(
        max_digits=15, decimal_places=2, verbose_name="Precio/Aumento"
    )
    porcentaje_impuesto = models.DecimalField(
        max_digits=15, decimal_places=2, verbose_name="% Impuesto"
    )
